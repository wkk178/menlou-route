...
def update_weights_from_data():
    ...
    if len(user_data) < 5: return False  # 数据量不足不更新
    ...
    for record in user_data[-50:]:  # 只看最近50条，避免历史数据干扰
...
NODES = [
    {"id": "N1", "name": "隆长寺山门", "door": "3号", "theme": "读门", "type": "文化", "stay": 15,
     ...
     "desc": "明代圣祚隆长寺旧址（随墙门）"},
    {"id": "N2", "name": "广亮大门", "door": "11号", "theme": "读门", "type": "文化", "stay": 10,
    ...
    {"id": "N5", "name": "广亮大门", "door": "27号", "theme": "读门", "type": "文化", "stay": 10,
     ...
     "desc": "广亮大门，保存完好"},
    {"id": "N6", "name": "广亮大门", "door": "33号", "theme": "读门", "type": "文化", "stay": 10,
     "lat": calc_coord(33)[0], "lng": calc_coord(33)[1], "interfere": 0.25, "tags": ["architecture"],
     "desc": "广亮大门，形制完整"},
    {"id": "N7", "name": "金柱大门", "door": "35号", "theme": "读门", "type": "文化", "stay": 10,
     "lat": calc_coord(35)[0], "lng": calc_coord(35)[1], "interfere": 0.25, "tags": ["architecture"],
     "desc": "金柱大门，砖雕精美"},
    {"id": "N8", "name": "程砚秋故居", "door": "39号", "theme": "推门", "type": "文化", "stay": 20,
    ...
    {"id": "N9", "name": "金柱大门", "door": "44号", "theme": "读门", "type": "文化", "stay": 10,
     ...
     "desc": "金柱大门，门楼形制完整"},
    {"id": "N10", "name": "开放院落", "door": "45号", "theme": "推门", "type": "文化", "stay": 15,
     "lat": calc_coord(45)[0], "lng": calc_coord(45)[1], "interfere": 0.4, "tags": ["history"],
     "desc": "随墙门，原汁原味"},
    {"id": "N11", "name": "京剧体验馆", "door": "17号", "theme": "创门", "type": "商业", "stay": 40,
     ...
     "desc": "御霜雅集主题"},
    {"id": "N12", "name": "拾光茶铺", "door": "21号", "theme": "创门", "type": "商业", "stay": 30,
