...
NODES = [
    # 文化景点
    {"id":"N1","name":"隆长寺山门","door":"3号","theme":"读门","type":"文化","stay":15,"lat":calc_coord(3)[0],"lng":calc_coord(3)[1],"interfere":0.2,"tags":["architecture","history"],"desc":"明代圣祚隆长寺旧址"},
    ...
    # 商业体验
    {"id":"N11","name":"京剧体验馆","door":"17号","theme":"创门","type":"商业","stay":40,"lat":calc_coord(17)[0],"lng":calc_coord(17)[1],"interfere":0.15,"tags":["handcraft","photo"],"desc":"御霜雅集主题"},
    {"id":"N12","name":"拾光茶铺","door":"21号","theme":"创门","type":"商业","stay":30,"lat":calc_coord(21)[0],"lng":calc_coord(21)[1],"interfere":0.1,"tags":["food","shopping"],"desc":"一院一茗特调茶"},
    {"id":"N13","name":"故事书店","door":"43号","theme":"创门","type":"商业","stay":25,"lat":calc_coord(43)[0],"lng":calc_coord(43)[1],"interfere":0.05,"tags":["shopping","history"],"desc":"门楼主题文创"},
    {"id":"N14","name":"胡同夜市","door":"50号","theme":"创门","type":"商业","stay":30,"lat":calc_coord(50)[0],"lng":calc_coord(50)[1],"interfere":0.35,"tags":["food","photo"],"desc":"胡同小吃摊位"}
]
